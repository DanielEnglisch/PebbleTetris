//       $Id: shape.c 36046 2017-11-11 15:09:28Z p20068 $
//      $URL: https://svn01.fh-hagenberg.at/bin/cepheiden/vocational/teaching/SE/SWO3/2017-WS/Ue/src/06/tetris-template/src/shape.c $
// $Revision: 36046 $
...
bool point_in_shape (GPoint const * const p_point, shape_t const * const p_shape) {
   assert (p_shape != NULL); return grect_contains_point (&(p_shape->box), p_point);
}
...
int* getRandomBlock(){
  ...
  switch(c){
    case 1: type = 0; return shape_l[0];
    break;
    case 2: type = 1; return shape_i[0]; 
    break;
    case 3: type = 2; return shape_l_inv[0];  
    break;
    case 4: type = 3; return shape_q[0]; 
    break;
    case 5: type = 4; return shape_sn[0]; 
    break;
    case 6: type = 5; return shape_sn_inv[0]; 
    break;
    case 7: type = 6; return shape_tee[0]; 
    break;
  }
  type = 0;
  return shape_l[0];
...
void rotateBlock(block* b){
  ...
  int *myType = NULL;
  switch(b->type){
    case 0: myType = shape_l[b->rotation];
    break;
    case 1: myType = shape_i[b->rotation];
    break;
    case 2: myType = shape_l_inv[b->rotation];
    break;
    case 3: myType = shape_q[b->rotation];
    break;
    case 4: myType = shape_sn[b->rotation];
    break;
    case 5: myType = shape_sn_inv[b->rotation];
    break;
    case 6: myType = shape_tee[b->rotation];
    break;
  }
